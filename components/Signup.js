...
export default function Signup() {
    ...
    const SignUpButton = React.forwardRef(({ onClick, href }, ref) => {
      ...
      const SignUpButton2 = React.forwardRef(({ onClick, href }, ref) => {
        return (
    ...
    return(
        <body>
            ...
            <main className="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
                <section>
                    <h3 className="font-bold text-2xl">Sign up for an account</h3>
                ...
                <section>
                    <form className="flex flex-col" method="POST" action="#">
                        <div className = "mb-6 pt-3 rounded bg-gray-200">
                            ...
                            <input type="text" id="firstname" className="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3"></input>
                        </div>
                        <div className = "mb-6 pt-3 rounded bg-gray-200">
                            <label className="block text-gray-700 text-sm font-bold mb-2 ml-3" htmlFor="last namel">Last Name</label>
                            <input type="text" id="lastname" className="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3"></input>
                        </div>
                        <div className = "mb-6 pt-3 rounded bg-gray-200">
